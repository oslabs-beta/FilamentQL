    ...
    <div style={{
      ...
      <div className='infoParentDiv'>
        <div className="Info_Headers">
          ...
          <p>FilamentQL's parsing algorithm only selects the fields within the query that are not in the cache. It then constructs a new query to be sent to the GraphQL server as well as package up the data from the cache. Once the data arrives from the database, FilamentQL combines the data into the same shape that was initially queried.</p>
